"""
Generated Playwright Test Case #29: TC-001 Smoke: Valid User Login
...
async def test_case_29(page: Page, base_url: str = "http://127.0.0.1:3000"):
    """Executes the test steps for TC #29."""
